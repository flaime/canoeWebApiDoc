...
<h1 id="kanot-lice-api">Kanot.lice API v1.0.0</h1>

> Scroll down for code samples, example requests and responses. Select a language for code samples from the tabs above or the mobile navigation menu.

Welcome to the kanot.live API by linus! You can use our API to access kanot.live API endpoints, which can get information on various competitions and for them races, people and so on. To show the application go to [kanot.live](https://kanot.live). Good to know is that the site is updated fairly regularly usually every 30 second with the latest data from the competitions that is active.

Base URLs:

* <a href="https://kanot.live/">https://kanot.live/</a>

* <a href="http://kanot.live/">http://kanot.live/</a>

<a href="http://kanot.live/terms/">Terms of service</a>
...
<h1 id="kanot-lice-api-pet">pet</h1>
...
curl -X POST https://kanot.live/pet \
...
result = RestClient.post 'https://kanot.live/pet',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X PUT https://kanot.live/pet \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer {access-token}'
...
result = RestClient.put 'https://kanot.live/pet',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X GET https://kanot.live/pet/findByStatus?status=available \
...
result = RestClient.get 'https://kanot.live/pet/findByStatus',
  params: {
  'status' => 'array[string]'
}, headers: headers
...
```shell
# You can also use wget
curl -X GET https://kanot.live/pet/findByTags?tags=string \
  -H 'Accept: application/xml' \
  -H 'Authorization: Bearer {access-token}'
...
result = RestClient.get 'https://kanot.live/pet/findByTags',
  params: {
  'tags' => 'array[string]'
}, headers: headers
...
```shell
# You can also use wget
curl -X GET https://kanot.live/pet/{petId} \
  -H 'Accept: application/xml' \
  -H 'api_key: API_KEY'
...
result = RestClient.get 'https://kanot.live/pet/{petId}',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X POST https://kanot.live/pet/{petId} \
...
result = RestClient.post 'https://kanot.live/pet/{petId}',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X DELETE https://kanot.live/pet/{petId} \
  -H 'api_key: string' \
  -H 'Authorization: Bearer {access-token}'
...
result = RestClient.delete 'https://kanot.live/pet/{petId}',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X POST https://kanot.live/pet/{petId}/uploadImage \
...
result = RestClient.post 'https://kanot.live/pet/{petId}/uploadImage',
  params: {
  }, headers: headers
...
<h1 id="kanot-lice-api-store">store</h1>
...
```shell
# You can also use wget
curl -X GET https://kanot.live/store/inventory \
  -H 'Accept: application/json' \
  -H 'api_key: API_KEY'
...
result = RestClient.get 'https://kanot.live/store/inventory',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X POST https://kanot.live/store/order \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/xml'
...
result = RestClient.post 'https://kanot.live/store/order',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X GET https://kanot.live/store/order/{orderId} \
  -H 'Accept: application/xml'
...
result = RestClient.get 'https://kanot.live/store/order/{orderId}',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X DELETE https://kanot.live/store/order/{orderId}
...
result = RestClient.delete 'https://kanot.live/store/order/{orderId}',
  params: {
  }
...
<h1 id="kanot-lice-api-user">user</h1>
...
```shell
# You can also use wget
curl -X POST https://kanot.live/user \
  -H 'Content-Type: application/json'
...
result = RestClient.post 'https://kanot.live/user',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X POST https://kanot.live/user/createWithArray \
  -H 'Content-Type: application/json'
...
result = RestClient.post 'https://kanot.live/user/createWithArray',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X POST https://kanot.live/user/createWithList \
  -H 'Content-Type: application/json'
...
result = RestClient.post 'https://kanot.live/user/createWithList',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X GET https://kanot.live/user/login?username=string&password=string \
  -H 'Accept: application/xml'
...
result = RestClient.get 'https://kanot.live/user/login',
  params: {
  'username' => 'string',
'password' => 'string'
}, headers: headers
...
```shell
# You can also use wget
curl -X GET https://kanot.live/user/logout
...
result = RestClient.get 'https://kanot.live/user/logout',
  params: {
  }
...
```shell
# You can also use wget
curl -X GET https://kanot.live/user/{username} \
  -H 'Accept: application/xml'
...
result = RestClient.get 'https://kanot.live/user/{username}',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X PUT https://kanot.live/user/{username} \
  -H 'Content-Type: application/json'
...
result = RestClient.put 'https://kanot.live/user/{username}',
  params: {
  }, headers: headers
...
```shell
# You can also use wget
curl -X DELETE https://kanot.live/user/{username}
...
result = RestClient.delete 'https://kanot.live/user/{username}',
  params: {
  }
